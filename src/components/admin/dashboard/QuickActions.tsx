  ...
  const actions = [
    {
      ...
      action: () => navigate('/admin-v2/highlights/create'),
    ...
    },
    {
      ...
      action: () => navigate('/admin-v2/events/create'),
    ...
    },
    {
      ...
      action: () => navigate('/admin-v2/venues/create'),
      variant: 'outline' as const,
    },
    {
      icon: Users,
      ...
      action: () => navigate('/admin-v2/organizers/create'),
      variant: 'outline' as const,
    },
  ];
