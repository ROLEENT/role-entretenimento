...
const HighlightComments = ({ highlightId }: HighlightCommentsProps) => {
    ...
    try {
      ...
      const { data, error } = await supabase
        ...
        .select(`
          *
        `)
        .eq('highlight_id', highlightId as any)
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Compartilhe sua opinião sobre este destaque
        </CardDescription>
      </CardHeader>
        ...
        {isAuthenticated ? (
          <form onSubmit={handleSubmitComment} className="space-y-4">
            <Textarea
              ...
              placeholder="Deixe seu comentário sobre este destaque..."
