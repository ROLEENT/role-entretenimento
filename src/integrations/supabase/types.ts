  ...
  public: {
    Tables: {
      ...
      event_series_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "event_series_items_event_id_fkey"
            columns: ["event_id"]
            isOneToOne: false
            referencedRelation: "agenda_itens"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_series_items_series_id_fkey"
            columns: ["series_id"]
            isOneToOne: false
