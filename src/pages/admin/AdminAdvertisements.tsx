...
import { Loader2, Edit, Trash2, Eye, EyeOff, Upload } from 'lucide-react';
                      ...
                      <Card key={ad.id} className="relative">
                        ...
                        <CardContent className="p-0">
                          <div 
                            ...
                            style={{
                              background: `linear-gradient(to right, ${ad.gradient_from || '#3B82F6'}, ${ad.gradient_to || '#8B5CF6'})`
                            }}
                          >
                          ...
                          <div className="p-4 space-y-2 text-sm text-muted-foreground">
                            ...
                            <p><strong>Posição:</strong> {ad.position}</p>
                            {ad.cta_url && (
                              <p><strong>URL:</strong> {ad.cta_url}</p>
                            )}
                          </div>
                        </CardContent>
                      </Card>
