...
-- 3) Tabela principal com estrutura correta
CREATE TABLE public.highlights (
  ...
  photo_credit TEXT,
  event_date DATE,
  slug_date TEXT GENERATED ALWAYS AS (to_char(event_date,'YYYY-MM-DD')) STORED,
...
-- 7) Políticas de Storage para bucket highlights
