-- FASE 2 - CRIAR FUNÇÕES RPC CORRIGIDAS PARA EVENTOS
-- Corrigir sintaxe das funções administrativas

-- Função para criar eventos (admin) - sintaxe corrigida
...
-- Função para atualizar eventos (admin) - sintaxe corrigida
