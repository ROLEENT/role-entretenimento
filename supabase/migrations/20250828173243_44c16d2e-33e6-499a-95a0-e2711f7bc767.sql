-- Remover funções com problema de parâmetros
DROP FUNCTION IF EXISTS public.admin_create_highlight_v2;
DROP FUNCTION IF EXISTS public.admin_update_highlight_v2;

-- Criar função de criação com parâmetros corretos (todos os defaults no final)
...
-- Função de atualização com parâmetros corretos
