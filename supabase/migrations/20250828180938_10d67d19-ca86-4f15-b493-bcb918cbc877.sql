-- Limpeza completa: Remover TODAS as versões das funções de highlights
DROP FUNCTION IF EXISTS admin_create_highlight_v2;
DROP FUNCTION IF EXISTS admin_update_highlight_v2;
DROP FUNCTION IF EXISTS admin_get_highlight_by_id;
