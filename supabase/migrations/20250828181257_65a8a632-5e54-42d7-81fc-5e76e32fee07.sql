-- Limpeza total usando CASCADE para remover todas as versões
DROP FUNCTION IF EXISTS admin_create_highlight_v2 CASCADE;
DROP FUNCTION IF EXISTS admin_update_highlight_v2 CASCADE;
DROP FUNCTION IF EXISTS admin_get_highlight_by_id CASCADE;

-- Recriar função para criar highlight
CREATE FUNCTION admin_create_highlight_v2(
  p_admin_email text,
  p_city text,
  p_event_title text,
  p_venue text,
...
CREATE FUNCTION admin_update_highlight_v2(
  p_admin_email text,
  p_highlight_id uuid,
  p_city text,
  p_event_title text,
...
CREATE FUNCTION admin_get_highlight_by_id(
  p_admin_email text,
  p_highlight_id uuid
)
RETURNS TABLE(
