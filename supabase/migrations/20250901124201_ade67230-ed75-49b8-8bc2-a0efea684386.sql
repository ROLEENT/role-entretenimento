...
CREATE INDEX idx_profile_media_position ON public.profile_media(profile_id, position);
CREATE INDEX idx_profile_reviews_profile_id ON public.profile_reviews(profile_id);
CREATE INDEX idx_profile_reviews_rating ON public.profile_reviews(profile_id, rating);