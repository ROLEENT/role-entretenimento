-- Create triggers to synchronize administrative forms with entity_profiles (CORRECTED)
...
BEGIN
    ...
    ELSE
        -- Create new entity_profile with state field
...
-- Initial sync of existing data (CORRECTED)
INSERT INTO entity_profiles (
    source_id, type, name, handle, bio, bio_short, city, state, country,
    contact_email, contact_phone, website, avatar_url, cover_url,
...
INSERT INTO entity_profiles (
    source_id, type, name, handle, bio, bio_short, city, state, country,
    contact_email, contact_phone, website, links, visibility, created_at, updated_at
)
SELECT 
    o.id,
    'organizador',
...
INSERT INTO entity_profiles (
    source_id, type, name, handle, bio, bio_short, city, state, country,
    contact_email, contact_phone, website, links, cover_url,
