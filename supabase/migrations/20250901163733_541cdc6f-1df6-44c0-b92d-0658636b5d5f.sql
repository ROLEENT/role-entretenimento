-- Create triggers to synchronize administrative forms with entity_profiles (FINAL CORRECTED VERSION)
...
-- Initial sync of existing data (FINAL VERSION)
INSERT INTO entity_profiles (
...
INSERT INTO entity_profiles (
    source_id, type, name, handle, bio, bio_short, city, state, country,
    contact_email, contact_phone, links, cover_url,
