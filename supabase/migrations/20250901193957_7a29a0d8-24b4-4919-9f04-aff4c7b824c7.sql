-- Correções RLS Phase 2 - versão corrigida
-- Apenas adicionar SET search_path em functions públicas e seguras

-- 1. Adicionar SET search_path = 'public' em functions seguras
...
BEGIN
  ...
  -- Verificar se não está em uso (comentado pois coluna não existe)
