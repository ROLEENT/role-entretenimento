-- Fix venue visibility issues (simplified)
...
-- 2. Update the profiles_with_stats view to include both 'public' and 'published' profiles (simplified without interactions)
