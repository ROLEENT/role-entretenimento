-- Fase 2: Estrutura Completa do Banco de Dados (Corrigida)

-- 1. Criar enums em falta
CREATE TYPE IF NOT EXISTS age_rating AS ENUM ('L', '10', '12', '14', '16', '18');
CREATE TYPE IF NOT EXISTS partner_role AS ENUM ('organizer', 'supporter', 'sponsor');
