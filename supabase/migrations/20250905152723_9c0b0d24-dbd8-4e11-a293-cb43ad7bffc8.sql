...
DROP POLICY IF EXISTS "temporary_dev_full_access" ON public.events;

-- 2. Garantir que RLS está habilitado
ALTER TABLE public.events ENABLE ROW LEVEL SECURITY;

-- 3. Criar UMA política simples e funcional para desenvolvimento
-- Esta política permite todas as operações sem restrições
CREATE POLICY "dev_unrestricted_access" 
ON public.events 
FOR ALL 
TO public
USING (true) 
