...
-- Seguir entidades
-- entity_type governa se usa entity_uuid ou entity_slug
-- city e tag usam entity_slug
CREATE TABLE IF NOT EXISTS public.follows (
  ...
  CONSTRAINT follows_user_entity_unique UNIQUE (user_id, entity_type, COALESCE(entity_uuid::text, entity_slug))
);
...
CREATE INDEX IF NOT EXISTS idx_follows_type_slug ON public.follows (entity_type, entity_slug);
CREATE INDEX IF NOT EXISTS idx_follows_type_uuid ON public.follows (entity_type, entity_uuid);
