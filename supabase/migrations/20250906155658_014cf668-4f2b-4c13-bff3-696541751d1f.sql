-- PLANO DE RECUPERAÇÃO DOS ARTISTAS ORIGINAIS (CORRIGIDO)
...
-- 2. Restaurar artistas originais com dados completos 
...
-- 4. Remover artistas fake que foram criados temporariamente
...
SELECT 
    ...
    array_agg(stage_name ORDER BY created_at) as artist_names
FROM public.artists;