-- PRIMEIRO: Remover completamente a função defeituosa que ainda existe
...
DROP FUNCTION IF EXISTS public.validate_artist_name_not_fake() CASCADE;
DROP FUNCTION IF EXISTS public.validate_artist_name_safe() CASCADE;

-- SEGUNDO: Restaurar artistas originais (agora sem validação bloqueando)
...
-- Remover artistas fake se existirem
