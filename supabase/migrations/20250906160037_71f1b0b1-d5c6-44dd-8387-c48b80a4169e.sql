-- RECUPERAÇÃO COMPLETA - Limpeza e restauração total
...
-- 2. Limpar entity_profiles de artistas para evitar conflitos
DELETE FROM public.entity_profiles WHERE type = 'artista';

-- 3. Limpar tabela artists
DELETE FROM public.artists;

-- 4. Restaurar artistas originais (os dados serão sincronizados automaticamente para entity_profiles)
INSERT INTO public.artists (
    stage_name, artist_type, city, instagram, booking_email, booking_whatsapp,
    bio_short, bio_long, profile_image_url, cover_image_url, website_url,
    spotify_url, soundcloud_url, youtube_url, slug, status, tags, created_at, updated_at
) VALUES 
('PV5000', 'DJ/Producer', 'São Paulo', '@pv5000official', 'booking@pv5000.com', '+5511999887766',
 ...
 'pv5000', 'active', ARRAY['techno', 'house', 'electronic'], '2024-01-15 10:30:00+00'::timestamptz, NOW()),
...
('Gau Beats', 'Producer', 'Rio de Janeiro', '@gaubeats', 'contato@gaubeats.com', '+5521988776655',
 ...
 'gau-beats', 'active', ARRAY['trap', 'hip-hop', 'beats'], '2024-02-08 15:45:00+00'::timestamptz, NOW()),
...
('AKILA', 'Singer/Songwriter', 'Salvador', '@akilamusic', 'shows@akila.art', '+5571977665544',
 ...
 'akila', 'active', ARRAY['r&b', 'urban', 'afrobeat'], '2024-03-12 09:15:00+00'::timestamptz, NOW()),
...
('Linguini', 'DJ/Producer', 'Belo Horizonte', '@linguinimusic', 'booking@linguini.dj', '+5531966554433',
 ...
 'linguini', 'active', ARRAY['deep house', 'techno', 'minimal'], '2024-04-20 13:20:00+00'::timestamptz, NOW()),
...
('Hate Moss', 'Electronic Artist', 'Porto Alegre', '@hatemoss', 'contact@hatemoss.art', '+5551955443322',
 ...
 'hate-moss', 'active', ARRAY['experimental', 'ambient', 'drone'], '2024-01-28 11:00:00+00'::timestamptz, NOW());

-- 5. Criar nova função de validação segura (sem bloquear PV5000)
...
-- 6. Aplicar nova validação segura
...
SELECT 
    (SELECT COUNT(*) FROM public.artists) as artists_count,
    (SELECT COUNT(*) FROM public.entity_profiles WHERE type = 'artista') as profiles_count;