-- Corrigir associação de artistas ao evento FINAL DRAG RACE na tabela events
-- O evento está na tabela events, não agenda_itens
DO $$
DECLARE
    ...
    v_katrina_id UUID;
BEGIN
    -- Buscar ou criar artistas mencionados no evento
    ...
    -- Se não conseguiu via RETURNING, buscar o ID
    ...
    -- Criar agenda item correspondente para o evento
    ...
    RAISE NOTICE 'Artistas associados ao evento FINAL DRAG RACE: %, %, %', v_tristan_id, v_dylan_id, v_katrina_id;
END $$;