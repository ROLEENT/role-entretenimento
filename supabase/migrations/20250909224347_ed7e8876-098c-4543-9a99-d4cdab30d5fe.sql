-- Criar entrada manual na agenda_itens para o evento com alt_text obrigatório
INSERT INTO agenda_itens (
    id, title, slug, subtitle, summary, city, starts_at, end_at, 
    status, cover_url, alt_text, location_name, organizer_id, created_at, updated_at,
...
VALUES (
    ...
    'Final Drag Race BR - Watch Party na Workroom com performances drags',
    'Workroom',
