-- ETAPA 1: Correção Imediata de Segurança - Parte 2

-- 1. Remover função existente com CASCADE e recriar
DROP FUNCTION IF EXISTS public.is_admin_session_valid(text) CASCADE;
...
-- 5. Corrigir configurações de read-only
SET transaction_read_only = off;
SET default_transaction_read_only = off;

-- 6. Garantir que admin de referência está ativo
