...
DROP POLICY IF EXISTS "Admins can view all sessions for moderation" ON public.user_sessions;
...
DROP POLICY IF EXISTS "Admins can view all transactions for support" ON public.payment_transactions;
